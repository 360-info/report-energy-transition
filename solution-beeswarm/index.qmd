...
subtitle: "Solutions with more potential to reduce emissions are shown as **larger circles**. They are grouped by their estimated cost as of 2030. They are 'sufficient to reduce global greenhouse gas (GHG) emissions to half of the current (2019) level or less,' <a href='https://www.ipcc.ch/report/ar6/wg3/downloads/report/IPCC_AR6_WGIII_FullReport.pdf'>according to the IPCC</a>."
format:
...
// we're going to rotate this plot when 
